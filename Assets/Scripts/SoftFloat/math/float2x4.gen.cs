...
namespace UnityS.Mathematics
{
    ...
    public partial struct float2x4 : System.IEquatable<float2x4>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float2x4(sfloat m00, sfloat m01, sfloat m02, sfloat m03,
        ...
        public float2x4(bool v)
        {
            ...
            this.c2 = math.select(new float2(sfloat.Zero), new float2(sfloat.One), v);
            this.c3 = math.select(new float2(sfloat.Zero), new float2(sfloat.One), v);
        }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float2x4(sfloat v) { return new float2x4(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x4 operator * (float2x4 lhs, sfloat rhs) { return new float2x4 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs, lhs.c3 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a float value and a float2x4 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x4 operator * (sfloat lhs, float2x4 rhs) { return new float2x4 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2, lhs * rhs.c3); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x4 operator < (float2x4 lhs, sfloat rhs) { return new bool2x4 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs, lhs.c3 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a float value and a float2x4 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool2x4 operator < (sfloat lhs, float2x4 rhs) { return new bool2x4 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2, lhs < rhs.c3); }
    ...
    public static partial class math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x4 float2x4(sfloat m00, sfloat m01, sfloat m02, sfloat m03,
                                        sfloat m10, sfloat m11, sfloat m12, sfloat m13)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float2x4 float2x4(sfloat v) { return new float2x4(v); }
