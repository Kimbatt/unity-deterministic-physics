...
namespace UnityS.Mathematics
{
    ...
    public partial struct float3x3 : System.IEquatable<float3x3>, IFormattable
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public float3x3(sfloat m00, sfloat m01, sfloat m02,
                        sfloat m10, sfloat m11, sfloat m12,
                        sfloat m20, sfloat m21, sfloat m22)
        {
        ...
        {
            this.c0 = new float3(v.c0);
            this.c1 = new float3(v.c1);
            this.c2 = new float3(v.c2);
        }


        /// <summary>Implicitly converts a single float value to a float3x3 matrix by assigning it to every component.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static implicit operator float3x3(sfloat v) { return new float3x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 operator * (float3x3 lhs, sfloat rhs) { return new float3x3 (lhs.c0 * rhs, lhs.c1 * rhs, lhs.c2 * rhs); }

        /// <summary>Returns the result of a componentwise multiplication operation on a float value and a float3x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 operator * (sfloat lhs, float3x3 rhs) { return new float3x3 (lhs * rhs.c0, lhs * rhs.c1, lhs * rhs.c2); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool3x3 operator < (float3x3 lhs, sfloat rhs) { return new bool3x3 (lhs.c0 < rhs, lhs.c1 < rhs, lhs.c2 < rhs); }

        /// <summary>Returns the result of a componentwise less than operation on a float value and a float3x3 matrix.</summary>
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static bool3x3 operator < (sfloat lhs, float3x3 rhs) { return new bool3x3 (lhs < rhs.c0, lhs < rhs.c1, lhs < rhs.c2); }
    ...
    public static partial class math
    {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 float3x3(sfloat m00, sfloat m01, sfloat m02,
                                        sfloat m10, sfloat m11, sfloat m12,
                                        sfloat m20, sfloat m21, sfloat m22)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static float3x3 float3x3(sfloat v) { return new float3x3(v); }
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public static sfloat determinant(float3x3 m)
        {
            float3 c0 = m.c0;
            float3 c1 = m.c1;
            float3 c2 = m.c2;

            sfloat m00 = c1.y * c2.z - c1.z * c2.y;
            sfloat m01 = c0.y * c2.z - c0.z * c2.y;
            sfloat m02 = c0.y * c1.z - c0.z * c1.y;
